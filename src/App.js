...
function App() {
  ...
  const [chat, setChat] = useState([{ role: "system", content: "You are a helpful assistant. You get prompts which get generated by speech input through a microphone. Only speak in completed sentences." }]);
  ...
  async function sendChatGptRequest(chat) {
    ...
    const options = {
      maxTokens: 200 //adjust this value to 100 if generating time still takes too long for good UX
    }
